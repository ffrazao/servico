...
public class _TransactionManagementConfig {
	...
	public UserTransactionServiceImp userTransactionServiceImp() {
		...
		// properties.setProperty(AbstractUserTransactionServiceFactory.MAX_TIMEOUT_PROPERTY_NAME,
		// "900000000");
		// properties.setProperty(AbstractUserTransactionServiceFactory.DEFAULT_JTA_TIMEOUT_PROPERTY_NAME,
		// "900000000");

		// result.init(properties);
		// este código não é necessário, pois o arquivo jta.properties já está
		// fazendo isso
